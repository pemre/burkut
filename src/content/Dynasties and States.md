...
* 🟢 Antik Çin (yeşil),
* 🟠 Erken İmparatorluk Çağı (turuncu),
* 🟤 Bölünmüşlük Çağı (kahverengi),
* 🔵 Orta İmparatorluk Çağı (mavi),
* 🟣 Geç İmparatorluk Çağı (mor) ve
* 🔴 Modern Çin (kırmızı).

* Bu dönemler içinde yer alan hanedanlar ve devletlerin üzerine tıklayarak ayrıntılı bilgiye ulaşabilirsiniz.
