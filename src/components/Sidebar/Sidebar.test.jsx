...
const mockIndex = {
  xia: { id: "xia", group: "Hanedanlar", title: "Xia Hanedanı" },
  shang: { id: "shang", group: "Hanedanlar", title: "Shang Hanedanı" },
  ed_1: { id: "ed_1", group: "Edebiyat", title: "Yazının Doğuşu" },
};
...
describe("Sidebar", () => {
  it("tüm grupları render eder", () => {
    ...
    expect(screen.getByText("Hanedanlar")).toBeInTheDocument();
    expect(screen.getByText("Edebiyat")).toBeInTheDocument();
    expect(screen.getByText("Sinema")).toBeInTheDocument();
  });
  ...
  it("grup tıklandığında onSelectGroup çağrılır", () => {
    ...
    fireEvent.click(screen.getByText("Edebiyat"));
    expect(onSelectGroup).toHaveBeenCalledWith("Edebiyat");
  });
